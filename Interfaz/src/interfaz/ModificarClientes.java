...
public class ModificarClientes extends javax.swing.JFrame {
    ...
    public ModificarClientes(String nombre, String nit, String direccion, String id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Nit del cliente:");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            PreparedStatement ActualizarProveedor = cn.prepareStatement("UPDATE clientes SET nombrecli = '"+jTextField1.getText()+"', direccion = '"+jTextField3.getText()+"', nit = '"+jTextField2.getText()+"' WHERE id='"+ID+"' ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarClientes(null, null, null, null).setVisible(true);
            }
        });
    }
