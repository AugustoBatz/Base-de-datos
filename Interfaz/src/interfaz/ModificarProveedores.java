...
public class ModificarProveedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Nit del proveedor:");

        jLabel5.setText("Direccion del proveedor:");

        jButton1.setText("Modificar datos y regresar");
        ...
        jLabel1.setText("Modificación de proveedores:");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            PreparedStatement ActualizarProveedor = cn.prepareStatement("UPDATE proveedores SET nombreprov = '"+jTextField1.getText()+"', direccion = '"+jTextField3.getText()+"', nit = '"+jTextField2.getText()+"' WHERE id='"+ID+"' ");
        ...
        Proveedores pv = new Proveedores(0);
        pv.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarProveedores(null, null, null, null).setVisible(true);
            }
        });
    }
