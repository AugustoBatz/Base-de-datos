...
public class ModificarProductos extends javax.swing.JFrame {
    ...
    public ModificarProductos(String id, String nombre, String preciov, String marca, String existencia, String precioc) {
        ...
        jTextField4.setText(existencia);
        jTextField5.setText(precioc);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificacion Productos:");

        jLabel2.setText("Nombre:");

        jLabel3.setText("Precio al que se vendera:");

        jLabel4.setText("Marca:");

        jLabel5.setText("Existencia:");

        jLabel6.setText("Precio al que se compro:");

        jButton1.setText("Finalizar y regresar");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            PreparedStatement ActualizarProductos = cn.prepareStatement("UPDATE producto SET nombre = '"+jTextField1.getText()+"', preciostock = '"+jTextField2.getText()+"', marca = '"+jTextField3.getText()+"', existencia = '"+jTextField4.getText()+"', preciocompra = '"+jTextField5.getText()+"' WHERE idprod = '"+ID+"' ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarProductos(null, null, null, null, null, null).setVisible(true);
            }
        });
    }
